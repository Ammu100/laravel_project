...
<section class="w3l-mag-main">
					...
					<div class="maghny-gd-1 col-lg-6">
						<div class="maghny-grid">
							<figure class="effect-lily">
								<img class="img-fluid" src="{{asset('/')}}assets/images/grid20.jpg" alt="">
					...
					<div class="maghny-gd-1 col-lg-6">
						<div class="row">
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid7.jpg">
										<figcaption>
											<div>
								...
								<div class="mag-post-meta mt-3"><span class="meta-author text-uppercase"><span>By&nbsp;</span><a href="#" class="author-name"> John
											Brain</a> </span>
							...
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid8.jpg">
										<figcaption>
											<div>
			...
			<div class="blog-inner-grids py-md-4 row">
				<div class="mag-content-left-hny col-lg-8">
					...
					<div class="mag-hny-content">
						...
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-lg-4 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid1.jpg" alt="">
										<figcaption>
											<div>
								...
								<div class="mag-post-meta mt-3"><a href="#"><img src="{{asset('/')}}assets/images/admin.jpg" class="img-fluid rounded-circle admin-img" alt=""></a> <span class="meta-author"><span>By&nbsp;</span><a href="#" class="author-name">John
											Brain</a> </span>
									<span class="author-date">Jan 5, 2020</span>
								</div>
							</div>
							<div class="maghny-gd-1 col-lg-4 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid2.jpg" alt="">
										<figcaption>
											<div>
							...
							<div class="maghny-gd-1 col-lg-4 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid3.jpg" alt="">
										<figcaption>
											<div>
					...
					<div class="mag-hny-content my-lg-5">
						...
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid4.jpg" alt="">
										<figcaption>
											<div>
								...
								<div class="mag-post-meta"><a href="#"><img src="{{asset('/')}}assets/images/admin.jpg" class="img-fluid rounded-circle admin-img admin-img1" alt=""></a> <span class="meta-author"><span>By&nbsp;</span><a href="#" class="author-name">John
											Brain</a> </span>
									<span class="author-date">Jan 5, 2020</span>
								</div>
							</div>
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid5.jpg">
										<figcaption>
											<div>
						...
						<div class="row mng-front-cont mt-5">
							<div class="mag-small-post col-md-6">
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m1.jpg" class="img-fluid" alt=""></a>
									...
									<div class="mag-post-details col-8">
										...
										<div class="mag-post-meta mt-3"> <span class="meta-author"><span>By&nbsp;</span><a href="#" class="author-name"> John Brain</a> </span>
											<span class="author-date">Jan 5, 2020</span>
										</div>
									</div>
								</div>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m2.jpg" class="img-fluid" alt=""></a>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m3.jpg" class="img-fluid" alt=""></a>
									...
									<div class="mag-post-details col-8">
										...
										<div class="mag-post-meta"> <span class="meta-author"><span>By&nbsp;</span><a href="#" class="author-name"> John Brain</a> </span>
											<span class="author-date">Jan 5, 2020</span>
										</div>
									</div>
								</div>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m4.jpg" class="img-fluid" alt=""></a>
							...
							<div class="mag-small-post col-md-6">
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m12.jpg" class="img-fluid" alt=""></a>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m9.jpg" class="img-fluid" alt=""></a>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m10.jpg" class="img-fluid" alt=""></a>
								...
								<div class="post-item-grid row mb-4">
									<div class="mag-post-thumb col-4">
										<a href="#"><img src="{{asset('/')}}assets/images/m11.jpg" class="img-fluid" alt=""></a>
					...
					<div class="mag-hny-content my-lg-5 mt-5">
						...
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-lg-4 col-md-6">
								<div class="maghny-grid">
									<figure class="effect-lily">
										<img class="img-fluid" src="{{asset('/')}}assets/images/grid6.jpg">
										<figcaption>
											<div>
					...
					<div class="mag-hny-content mb-5">
						...
						<div class="maghny-grids-inf row">
							<div class="mag-post-thumb col-md-6">
								<a href="#"><img src="{{asset('/')}}assets/images/grid9.jpg" class="img-fluid" alt=""></a>
							...
							<div class="mag-post-fashion-details col-md-6 mt-md-0 mt-4">
								...
								<div class="mag-post-meta mt-3"><a href="#"><img src="{{asset('/')}}assets/images/admin.jpg" class="img-fluid rounded-circle admin-img admin-img1" alt=""></a> <span class="meta-author"> <span>By&nbsp;</span><a href="#" class="author-name"> John
											Brain</a> </span>
									<span class="author-date">Jan 5, 2020</span>
								</div>
						...
						<div class="maghny-grids-inf row my-5">
							<div class="mag-post-thumb col-md-6">
								<a href="#"><img src="{{asset('/')}}assets/images/grid10.jpg " class="img-fluid" alt=""></a>
						...
						<div class="maghny-grids-inf row">
							<div class="mag-post-thumb col-md-6">
								<a href="#"><img src="{{asset('/')}}assets/images/grid5.jpg" class="img-fluid" alt=""></a>
								...
								<div class="fas-gallery-grid">
									<a href="#">
										<div class="content">
											...
											<img src="{{asset('/')}}assets/images/grid11.jpg" class="img-fluid" alt="">
							...
							<div class="fashion-gd-1 col-lg-4 col-6">
								<div class="fas-gallery-grid">
									<a href="#">
										<div class="content">
											<div class="content-overlay"></div>
											<img src="{{asset('/')}}assets/images/grid12.jpg" class="img-fluid" alt="">
											<div class="content-details fadeIn-bottom">
							...
							<div class="fashion-gd-1 col-lg-4 col-6">
								<div class="fas-gallery-grid">
									<a href="#">
										<div class="content">
											<div class="content-overlay"></div>
											<img src="{{asset('/')}}assets/images/grid13.jpg" class="img-fluid" alt="">
											<div class="content-details fadeIn-bottom">
					...
					<div class="mag-hny-content my-lg-5 mb-5">
						...
						<div class="maghny-grids-inf row">
							<div class="mag-post-thumb col-md-6">
								<a href="#"><img src="{{asset('/')}}assets/images/grid16.jpg" class="img-fluid" alt=""></a>
						...
						<div class="maghny-grids-inf row my-5">
							<div class="mag-post-thumb col-md-6">
								<a href="#"><img src="{{asset('/')}}assets/images/grid17.jpg " class="img-fluid" alt=""></a>
						...
						<div class="maghny-grids-inf row">
							<div class="mag-post-thumb col-md-6">
								<a href="#"><img src="{{asset('/')}}assets/images/grid13.jpg" class="img-fluid" alt=""></a>
						...
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid mb-3">
									<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/grid14.jpg" alt=""></a>
								</div>
								<h5><a href="#">
										There are many variations that focuses on presenting</a></h5>
								<p>Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.</p>
							...
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid mb-3">
									<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/grid15.jpg" alt=""></a>
								</div>
								<h5><a href="#">
										There are many variations that focuses on presenting</a></h5>
								<p>Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.</p>
						...
						<div class="mag-small-post my-lg-3">
							<div class="social-media-icons row">
								<div class="grid-social-box col-lg-3 col-sm-6">
									<a href="#" class="sub-facebook"><span class="fa fa-facebook" aria-hidden="true"></span>
										<div class="soc-info">
								...
								<div class="grid-social-box col-lg-3 col-sm-6 ">
									<a href="#" class="sub-facebook twitter"><span class="fa fa-twitter" aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">14,507</span>
											<span class="sub_social_info sub_social_info_name">Followers</span>
										</div>
								...
								<div class="grid-social-box col-lg-3 col-sm-6 ">
									<a href="#" class="sub-facebook google"><span class="fa fa-google" aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">14,507</span>
											<span class="sub_social_info sub_social_info_name">Followers</span>
										</div>
								...
								<div class="grid-social-box col-lg-3 col-sm-6 ">
									<a href="#" class="sub-facebook dribble"><span class="fa fa-dribbble" aria-hidden="true"></span>
										<div class="soc-info">
											<span class="sub_social_info sub_social_info_counter">14,507</span>
											<span class="sub_social_info sub_social_info_name">Followers</span>
										</div>
					...
					<div class="mag-hny-content my-5">
						...
						<div class="maghny-grids-inf row">
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid mb-3">
									<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/grid18.jpg" alt=""></a>
								</div>
								<h5><a href="#">
										There are many variations that focuses on presenting</a></h5>
								<p>Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.</p>
							...
							<div class="maghny-gd-1 col-md-6">
								<div class="maghny-grid mb-3">
									<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/grid19.jpg" alt=""></a>
								</div>
								<h5><a href="#">
										There are many variations that focuses on presenting</a></h5>
								<p>Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.</p>
								...
								<div class="item">
									<a href="#link">
										<div class="gallery-grid">
											<div class="content">
												<div class="content-overlay"></div>
												<img src="{{asset('/')}}assets/images/grid1.jpg" class="image-two img-fluid">
								...
								<div class="item">
									<a href="#link">
										<div class="gallery-grid">
											<div class="content">
												<div class="content-overlay"></div>
												<img src="{{asset('/')}}assets/images/grid2.jpg" class="image-two img-fluid">
								...
								<div class="item">
									<a href="#link">
										<div class="gallery-grid">
											<div class="content">
												<div class="content-overlay"></div>
												<img src="{{asset('/')}}assets/images/grid3.jpg" class="image-two img-fluid">
								...
								<div class="item">
									<a href="#link">
										<div class="gallery-grid">
											<div class="content">
												<div class="content-overlay"></div>
												<img src="{{asset('/')}}assets/images/grid6.jpg" class="image-two img-fluid">
								...
								<div class="item">
									<a href="#link">
										<div class="gallery-grid">
											<div class="content">
												<div class="content-overlay"></div>
												<img src="{{asset('/')}}assets/images/grid7.jpg" class="image-two img-fluid">
								...
								<div class="item">
									<a href="#link">
										<div class="gallery-grid">
											<div class="content">
												<div class="content-overlay"></div>
												<img src="{{asset('/')}}assets/images/grid8.jpg" class="image-two img-fluid">
					...
					<aside>
						<div class="side-bar-hny-recent mb-5">
							...
							<div class="mag-small-post">
								<div class="post-item-grid row mb-4">
									...
									<div class="mag-post-details col-8">
										<h4 class="mag-post-title">
											<a href="#">Group of women dancing on stage</a>
										</h4>
								...
								<div class="post-item-grid row mb-4">
									...
									<div class="mag-post-details col-8">
										<h4 class="mag-post-title">
											<a href="#">Pancake with chocolate syrup on ceramic plate</a>
										</h4>
						...
						<div class="side-bar-hny-recent mb-5">
							...
							<div class="mag-small-post">
								...
								<div class="post-item-grid align-items-center row mb-4">
									<div class="mag-post-thumb col-3 pl-0">
										<a href="#"><img src="{{asset('/')}}assets/images/m13.jpg" class="img-fluid" alt=""></a>
						...
						<div class="side-bar-hny-recent mb-5">
							<div class="mag-small-post">
								<div class="mag-add-post">
									<a href="#"><img src="{{asset('/')}}assets/images/add.jpg" alt="" class="img-fluid"></a>
								</div>
							</div>
						</div>
							...
							<div class="mag-small-post">
								<div class="post-video-grid">
									<div class="video-content mb-3">
										<a href="#notify" class="play-button btn"><span class="fa fa-play" aria-hidden="true">
										...
										<div id="notify" class="notify-pop-overlay">
											<div class="notify-popup">
												...
												<iframe src="https://player.vimeo.com/video/156953364" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
								...
								<div class="post-video-grid mt-5 mb-lg-5">
									<div class="video-content video-content2 mb-3">
										<a href="#notify1" class="play-button btn"><span class="fa fa-play" aria-hidden="true">
										...
										<div id="notify1" class="notify-pop-overlay">
											<div class="notify-popup">
												<h5>Watch Our Video</h5>
												<iframe src="https://player.vimeo.com/video/42638891" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
												<a class="close" href="#coming-s">&times;</a>
											</div>
										</div>
										<!-- //notify-popup -->
									...
									<h4 class="mag-post-title">
										<a href="#">Penguins on snow covered gound,Looking Awesome to see</a>
									</h4>
								</div>
							</div>
						</div>
							...
							<div class="mag-small-post">
								<div class="post-item-grid row mb-3">
									<div class="mag-post-thumb-img col-3">
										<a href="#"><img src="{{asset('/')}}assets/images/t4.jpg" class="img-fluid" alt=""></a>

									</div>
									<div class="mag-post-details col-9">
										<h4 class="mag-post-cate mb-2">
											<a href="#">Anna Delpan</a>
										</h4>
								...
								<div class="post-item-grid row mb-3">
									<div class="mag-post-thumb-img col-3">
										<a href="#"><img src="{{asset('/')}}assets/images/t1.jpg" class="img-fluid" alt=""></a>
								...
								<div class="post-item-grid row mb-3">
									<div class="mag-post-thumb-img col-3">
										<a href="#"><img src="{{asset('/')}}assets/images/t2.jpg" class="img-fluid" alt=""></a>
								...
								<div class="post-item-grid row mb-3">
									<div class="mag-post-thumb-img col-3">
										<a href="#"><img src="{{asset('/')}}assets/images/t3.jpg" class="img-fluid" alt=""></a>
						...
						<div class="side-bar-hny-recent mb-5">
							<div class="mag-small-post">
								<div class="mag-add-post">
									<a href="#"><img src="{{asset('/')}}assets/images/add1.jpg" alt="" class="img-fluid"></a>
								</div>
							</div>
						</div>
						<div class="side-bar-hny-recent mb-5">
							...
							<div class="mag-small-post dont-miss-grids-inf">
								<div class="maghny-gd-1">
									<div class="maghny-grid mb-3 dont-miss">
										<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/m5.jpg" alt=""></a>
									</div>
									<h5><a href="#">
											There are many variations that focuses on presenting</a></h5>
								...
								<div class="maghny-gd-1 my-lg-5">
									<div class="maghny-grid mb-3 dont-miss">
										<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/m6.jpg" alt=""></a>
									</div>
									<h5><a href="#">
											There are many variations that focuses on presenting</a></h5>
									<p>Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.
									</p>
									<div class="mag-post-meta"><a href="#"><img src="{{asset('/')}}assets/images/admin.jpg" class="img-fluid rounded-circle admin-img admin-img1" alt=""></a><span class="meta-author"><span>By&nbsp;</span><a href="#" class="author-name">
												John
												Brain</a> </span>
										<span class="author-date">Jan 5, 2020</span>
									</div>
								...
								<div class="maghny-gd-1">
									<div class="maghny-grid mb-3 dont-miss">
										<a href="#"><img class="img-fluid" src="{{asset('/')}}assets/images/m7.jpg" alt=""></a>
									</div>
									<h5><a href="#">
											There are many variations that focuses on presenting</a></h5>
									<p>Vivamus a ligula quam. Ut blandit eu leo non suscipit. Duis feugiat tortor sed.
						...
						<div class="side-bar-hny-recent mb-5">
							<div class="mag-small-post">
								<div class="mag-add-post">
									<a href="#"><img src="{{asset('/')}}assets/images/add3.jpg" alt="" class="img-fluid"></a>
								</div>
							</div>
						</div>
					</aside>
	...
	<!-- /slider -->
	<script src="{{asset('/')}}assets/js/jquery-3.3.1.min.js"></script>
	<script src="{{asset('/')}}assets/js/grids.owl.carousel.js"></script>
	<script>
